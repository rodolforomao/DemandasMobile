...
class DemandasPendenteView extends StatefulWidget {
 // final TbUsuario UsuarioLogado;
 // const ListaRodoviasView({Key key, @required this.UsuarioLogado}) : super(key: key);
  @override
  _DemandasPendenteView createState() => _DemandasPendenteView();

}

class _DemandasPendenteView  extends State<DemandasPendenteView> with TickerProviderStateMixin   {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Center( child: Text("Não existem demandas pendentes cadastradas.", textAlign: TextAlign.center,  style: TextStyle(fontFamily: 'BrandonText_Medium',  fontSize: 23.0, color: Color(0xFF545454)),),),
                SizedBox(height: 10.0),
                Center( child: Text("Vamos começar?",  style: TextStyle(fontFamily: 'BrandonText_Bold',  fontSize: 20.0, color: Color(0xFF545454)),),)
              ],
            ),
          ),
