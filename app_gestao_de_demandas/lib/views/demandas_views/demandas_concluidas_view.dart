...
class DemandasConcluidasView extends StatefulWidget {
  // final TbUsuario UsuarioLogado;
  // const ListaRodoviasView({Key key, @required this.UsuarioLogado}) : super(key: key);
  @override
  _DemandasConcluidasView createState() => _DemandasConcluidasView();

}

class _DemandasConcluidasView  extends State<DemandasConcluidasView> with TickerProviderStateMixin   {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Center( child: Text("Não existem demandas concluídas cadastradas.", textAlign: TextAlign.center,  style: TextStyle(fontFamily: 'BrandonText_Medium',  fontSize: 23.0, color: Color(0xFF545454)),),),
